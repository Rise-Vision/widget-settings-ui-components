...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("_angular/scroll-setting/scroll-setting.html",
    ...
    "        <option ng-show=\"showFastestSlowest\" value=\"slowest\">{{'scroll.speed.slowest' | translate}}</option>\n" +
    ...
    "        <option ng-show=\"showFastestSlowest\" value=\"fastest\">{{'scroll.speed.fastest' | translate}}</option>\n" +
    "      </select>\n" +
    "    </div>\n" +
    "  </div>\n" +
